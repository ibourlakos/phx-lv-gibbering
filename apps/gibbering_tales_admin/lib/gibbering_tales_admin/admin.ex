defmodule GibberingTalesAdmin.Admin do
  ...
  alias GibberingTalesAdmin.Admin.{SupportUser, AuditLog}
  ...
  defp maybe_terminate_scene_server(campaign_id) do
    case Registry.lookup(GibberingTalesWeb.GameRegistry, campaign_id) do
      [{pid, _}] -> DynamicSupervisor.terminate_child(GibberingTalesWeb.SceneSupervisor, pid)
      [] -> :ok
    end
  end
end

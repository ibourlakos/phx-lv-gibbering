defmodule Gibbering.Events.Upcaster do
  @moduledoc """
  Behaviour implemented by every event struct module in `Gibbering.Events`.
  ...
  Called by `Gibbering.Events.Decoder` for each version step during upcasting.

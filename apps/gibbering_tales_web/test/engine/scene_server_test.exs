defmodule GibberingTalesWeb.Engine.SceneServerTest do
  ...
  describe "move_entity/3" do
    ...
    test "broadcasts %EventBatch{} containing %EntityMoved{} on valid move" do
      game_id = start_server()
      Phoenix.PubSub.subscribe(GibberingTales.PubSub, SceneServer.topic(game_id))
  ...
  describe "dm_broadcast/2" do
    test "broadcasts %BroadcastSent{} to notifications topic subscribers" do
      game_id = start_server()
      Phoenix.PubSub.subscribe(GibberingTales.PubSub, SceneServer.notifications_topic(game_id))

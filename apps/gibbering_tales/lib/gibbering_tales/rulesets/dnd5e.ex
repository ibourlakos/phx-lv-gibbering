defmodule GibberingTales.Rulesets.DnD5e do
  @moduledoc """
  ...
  alias GibberingTales.Rulesets.DnD5e.{ModifierPipeline, RulesetState, Stats}
  ...
  def available_conditions do
    GibberingTales.Rulesets.DnD5e.Condition.all()

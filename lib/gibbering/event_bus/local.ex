defmodule Gibbering.EventBus.Local do
  @moduledoc """
  `Gibbering.EventBus` adapter for unit tests. No `Phoenix.PubSub` process required.
  ...
  Start it under a test supervisor:
      ...
      start_supervised!(Gibbering.EventBus.Local)

  Then point the adapter at it for the duration of the test:

      Application.put_env(:gibbering, Gibbering.EventBus, adapter: Gibbering.EventBus.Local)

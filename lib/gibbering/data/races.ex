defmodule Gibbering.Data.Races do
  @races %{
    ...
    "elf" => %{
      ...
      traits: [
        %{name: "Darkvision", description: "See in dim light within 60 ft as if bright; darkness as dim."},
        ...
        %{name: "Trance", description: "Elves don't sleep; they meditate for 4 hours instead of 8."}
      ],
      darkvision: true
    },
    "gnome" => %{
      ...
      traits: [
        ...
        %{name: "Artificer's Lore", description: "+2 bonus to History checks related to magic items, alchemy, or tech."}
      ],
      darkvision: true
    }
  }

...
**Next issue number:** 118 (see `counter`)
...
| [#116](116-sceneserver-coexist-typed-event-broadcast.md) | SceneServer: coexist typed event broadcast pattern | `architecture` `rules` | medium |
